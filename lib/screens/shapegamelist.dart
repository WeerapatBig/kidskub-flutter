import 'dart:math';
import 'dart:ui';
import 'package:firstly/function/pulse_effect.dart';
...
class ShapeGameList extends StatefulWidget {
  const ShapeGameList({super.key});

  @override
  _ShapeGameListState createState() => _ShapeGameListState();
}

class _ShapeGameListState extends State<ShapeGameList>
    ...
    return [
      {
        ...
        'lockedImage': 'assets/images/shapegame/card_lock.png',
        'unlockedImage': 'assets/images/shapegame/card_comic.png',
        'maxStars': 0,
        'earnedStars': 0,
        'starColor': '',
        'sticker': 'sticker1',
      },
      {
        ...
        'lockedImage': 'assets/images/shapegame/card_lock.png',
        'unlockedImage': 'assets/images/shapegame/lv1_card_unlock.png',
        'maxStars': 3,
        'earnedStars': 0,
        'starColor': 'yellow',
        'sticker': 'sticker2',
      },
      {
        ...
        'lockedImage': 'assets/images/shapegame/card_lock.png',
        'unlockedImage': 'assets/images/shapegame/lv2_card_unlock.png',
        'maxStars': 3,
        'earnedStars': 0,
        'starColor': 'yellow',
        'sticker': 'sticker3',
      },
      {
        ...
        'lockedImage': 'assets/images/shapegame/card_lock.png',
        'unlockedImage': 'assets/images/shapegame/quiz_card_unlock.png',
        'maxStars': 1,
        'earnedStars': 0,
        'starColor': 'purple',
        'sticker': 'sticker4',
    ...
    if (level['unlocked'] == true) {
      ...
      if (level['name'] == 'Motion') {
        ...
        result = await Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => GameShapeEasyScreen(),
          ),
        );
        ...
        result = await Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const GameShapeHardScreen(),
          ),
        );
        ...
        result = await Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                const ScreenGameShapeQuiz(), // เพิ่มหน้า QuizPage() ตามที่ต้องการ
          ),
        );
        if (result != null) {
          setState(() {
