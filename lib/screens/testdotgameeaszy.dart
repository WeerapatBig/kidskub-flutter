...
import 'package:firstly/function/drawing_effect.dart';
        ...
        return Positioned(
          ...
          child: Draggable<int>(
            ...
            childWhenDragging: CircleAvatar(
              radius: dotRadius,
              backgroundColor:
                  const ui.Color.fromARGB(255, 255, 159, 152).withOpacity(0.4),
            ),
            child: CircleAvatar(
              radius: dotRadius,
